...
EXCEPTIONS: dict[str, SPDXException] = {
    ...
    'asteriREDACTED_KEY': {'id': 'AsteriREDACTED_KEY', 'deprecated': False},
    'asteriREDACTED_KEY-protocols-exception': {'id': 'AsteriREDACTED_KEY-protocols-exception', 'deprecated': False},
