  ...
  return (
    <div className="p-6 bg-gradient-to-br from-zinc-900 to-black border border-white/10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-[9px] text-zinc-500 uppercase font-black tracking-[0.5em] mb-2">Memory Harmony Tier 7</h2>
        ...
        <div className="w-12 h-12 bg-white/5 border border-white/10 rounded-full flex items-center justify-center animate-spin-slow">
